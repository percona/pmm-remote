...
function install {
    ...
    *) fail "unknown os: $(uname -s)";;
    ...
    case "${OS}_${ARCH}" in
    "darwin_amd64")
        URL="https://github.com/${USER}/${PROG}/releases/download/${RELEASE}/${PROG}_${VERSION}_darwin_amd64.gz"
        FTYPE=".gz"
        ;;
    "darwin_arm")
        URL="https://github.com/${USER}/${PROG}/releases/download/${RELEASE}/${PROG}_${VERSION}_darwin_arm64.gz"
        FTYPE=".gz"
        ;;
    "linux_386")
        URL="https://github.com/${USER}/${PROG}/releases/download/${RELEASE}/${PROG}_${VERSION}_linux_386.gz"
        FTYPE=".gz"
        ;;
    "linux_amd64")
        URL="https://github.com/${USER}/${PROG}/releases/download/${RELEASE}/${PROG}_${VERSION}_linux_amd64.gz"
        FTYPE=".gz"
        ;;
    "linux_arm")
        URL="https://github.com/${USER}/${PROG}/releases/download/${RELEASE}/${PROG}_${VERSION}_linux_arm64.gz"
        FTYPE=".gz"
        ;;
    *) fail "No asset for platform ${OS}-${ARCH}";;
    ...
    if [[ $FTYPE = ".gz" ]]; then
        ...
        bash -c "$GET $URL" > "${PROG}_${OS}_${ARCH}" || fail "download failed"
    else
